...
def get_false_alarm_probability(image_in,
                                ...
                                plot=False):
    """
    Similar function to false_alarm but with more outputs including errors.
    """
...
#    print(separation, aperture_radius)
    ...
    science_flux = aperture_photometry(data=image_in,
                                       apertures=science_aperture,
                                       method="exact")["aperture_sum"].data[0]

    # Determine background fluxes
    bg_fluxes = aperture_photometry(data=image_in,
